...
export default function SprintCreate({ onClose }) {
  ...
  const loadRequirements = async () => {
    ...
    const arr = Object.entries(res).map(([key, val]) => ({
      key,
      title: val.title || "",
    }));
  ...
  return (
    <>
      ...
      {/* FIXED WRAPPER FOR RIGHT DRAWER */}
      <div className="drawer-container">
        ...
        <div className="sprint-panel open">
          ...
          >
            ...
            {/* ⭐ EXACT SAME AS ISSUE – now correct */}
            {requirements.map((req) => (
              <option key={req.key} value={req.title}>
                {req.title}
              </option>
            ))}
          </select>
