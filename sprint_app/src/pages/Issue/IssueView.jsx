...
export default function IssueView({ data, onClose }) {
  ...
  return (
    <>
      ...
      <aside className="sprint-panel open" aria-labelledby="issue-details">
        <div className="panel-head">
          <h3 id="issue-details" className="panel-title">Issue Details</h3>
